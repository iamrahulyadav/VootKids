...
public class VootConstants {
	...
	//public static final String email = "roja.kc@ifocussystec.com";
	//public static final String password = "rose";
	public static final String breakTray= "Top Kids Shows in English";
	...
	public static final String DEVICE_NAME="Mi A1";
	//public static final String UDID="RS50019e9bc7";
	public static final String DEVICE_VERSION="8.0.0";
	...
	public static final String MENU="//android.widget.ImageView[@resource-id='com.tv.v18.viola:id/hamburger_menu']";
